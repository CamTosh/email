<template>
  <div id="dashboard" class="inline-flex w-full flex-col items-center">
    ...
    <div class="w-3/4 mt-8 inline-flex flex-col cursor-pointer items-center justify-center">
      <div class="rounded bg-white w-full p-4 fill-current text-green-700 inline-flex shadow justify-between">
        
        <div class="text-gray-900 ml-4 inline-flex -ml-2">
          <svg  class="w-6 h-6 align-middle mr-1" width="24" height="24" fill="#333333" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g><path d="M134.961,466h242.078c27.57,0,50-22.43,50-50V166.104c0-2.746-1.129-5.371-3.123-7.26L307.683,48.74   c-1.857-1.76-4.318-2.74-6.877-2.74H134.961c-27.57,0-50,22.43-50,50v320C84.961,443.57,107.391,466,134.961,466z M312.363,80.722   l78.919,74.758h-68.919c-5.514,0-10-4.486-10-10V80.722z M104.961,96c0-16.542,13.458-30,30-30h157.402v79.48   c0,16.542,13.458,30,30,30h84.676V416c0,16.542-13.458,30-30,30H134.961c-16.542,0-30-13.458-30-30V96z"></path><path d="M293.586,358.799c1.873,1.572,4.154,2.34,6.423,2.34c2.854,0,5.688-1.215,7.665-3.572l31.195-37.177   c3.12-3.718,3.12-9.138,0-12.856l-31.195-37.177c-3.55-4.231-9.858-4.782-14.088-1.232c-4.23,3.55-4.783,9.857-1.232,14.088   l25.802,30.749l-25.802,30.749C288.803,348.942,289.355,355.249,293.586,358.799z"></path><path d="M204.326,357.567c1.978,2.357,4.812,3.573,7.665,3.572c2.269,0,4.55-0.768,6.423-2.34c4.23-3.55,4.783-9.857,1.232-14.088   l-25.802-30.749l25.802-30.749c3.551-4.231,2.998-10.538-1.232-14.088c-4.23-3.55-10.539-2.998-14.088,1.232l-31.195,37.177   c-3.12,3.718-3.12,9.138,0,12.856L204.326,357.567z"></path><path d="M245.099,385.81c0.509,0.077,1.014,0.115,1.513,0.115c4.859,0,9.123-3.55,9.874-8.501L275.288,253.5   c0.829-5.46-2.926-10.558-8.387-11.387c-5.46-0.83-10.559,2.926-11.387,8.386l-18.803,123.924   C235.883,379.884,239.638,384.982,245.099,385.81z"></path></g></svg>
          Code to embed on your website
        </div>
        <a href="https://email-landing.page/documentation" target="_blank" class="hover:bg-gray-800 bg-gray-700 text-white text-sm py-1 px-2 border border-gray-700 rounded mb-2 -mt-1 cursor-pointer">
          Docs
        </a>
      </div>
      <div class="w-full">
        <Embed v-if='campaignId' :campaignId="campaignId" />
      </div>
    </div>
    ...
    <div class="w-3/4 flex items-center mt-8 justify-center">
      <div class="w-full bg-white pt-4 rounded shadow">
        ...
        <div class="w-full py-3 text-center px-8">
          First you must be create an API Key (Coming Soon feature)
        </div>
      ...
      <div class="w-full bg-white pt-4 rounded shadow">
        <div class="w-full border-b border-gray-200">
          <div class="w-full inline-flex justify-between px-3 font-medium text-gray-600 mb-2">
            ...
            <div class="text-gray-700">(Coming Soon)</div>
          </div>
        </div>
